...
import { createSchedule, getSchedules, updateSchedule } from "./schedule.controller";
...
import { UpdateScheduleDto, updateScheduleSchema } from './schemas/update.schedule.dto';
